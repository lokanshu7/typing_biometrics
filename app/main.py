...
@app.post("/enroll", response_model=StandardResponse, tags=["Authentication"])
async def enroll(request: EnrollRequest) -> StandardResponse:
...
@app.post("/verify", response_model=StandardResponse, tags=["Authentication"])
async def verify(
